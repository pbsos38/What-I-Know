...
public class Papers extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        progressBar = v.findViewById(R.id.paper_progressBar);
        recyclerView = v.findViewById(R.id.recycler_papers);
    ...
    private void fetchPost(){
        ...
        con.loadWEbPosts_specific("start_others","3", new Callback<WebPost_bean>() {
            @Override
    ...
    public void LoadMore(int minID_r){
        SetDataToDatabase con = Conn.doConnect();
        con.loadWEbPosts_specific_more("more_others","3", minID_r, new Callback<WebPost_bean>() {
            @Override
            public void success(WebPost_bean webPost_bean, Response response) {
