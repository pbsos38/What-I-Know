...
public class Books extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        progressBar = v.findViewById(R.id.books_progressBar);
        ...
        //Snackbar.make(v,"https://www.facebook.com/", Snackbar.LENGTH_SHORT).show();
        return v;
    }
    ...
    private void fetchPost() {
        ...
        con.loadWEbPosts_specific("start_others", "2", new Callback<WebPost_bean>() {
            @Override
            public void success(WebPost_bean webPost_bean, Response response) {
                ...
                while (x < userBeans.size()) {
                    minID = userBeans.get(x).getId();
                    x++;
                }
    ...
    public void LoadMore(int minID_r) {
        SetDataToDatabase con = Conn.doConnect();
        con.loadWEbPosts_specific_more("more_others", "2", minID_r, new Callback<WebPost_bean>() {
            @Override
            public void success(WebPost_bean webPost_bean, Response response) {
