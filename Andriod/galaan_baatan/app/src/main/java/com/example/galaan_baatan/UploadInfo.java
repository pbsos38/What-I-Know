...
public class UploadInfo extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mRoofRef = new Firebase("https://fir-database-a5f78.firebaseio.com/").child("User_Details").push();  // Push will create new child every time we upload data
        mStorage = FirebaseStorage.getInstance().getReferenceFromUrl("gs://fir-database-a5f78.appspot.com");
        ...
        upload_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Firebase childRef_name = mRoofRef.child("Image_Url");
        ...
        if (requestCode == GALLERY_INTENT && resultCode == RESULT_OK) {
            ...
            filePath.putFile(mImageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    String downloadUri = taskSnapshot.getMetadata().getReference().getDownloadUrl().toString();  //Ignore This error

                    mRoofRef.child("Image_URL").setValue(downloadUri);
