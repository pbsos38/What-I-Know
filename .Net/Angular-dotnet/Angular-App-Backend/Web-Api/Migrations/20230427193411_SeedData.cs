...
namespace Web_Api.Migrations
{
    ...
    public partial class SeedData : Migration
    {
        ...
        {
            // Update the seeding file accroding to this file
...
--Seed CityList
--------------------------
IF not exists (select top 1 id from CityList)
Insert into CityList(Name,LastUpdatedBy,LastUpdatedOn,Country)
...
(select top 1 Id from CityList), -- City ID
3, -- Floor No
3, --Total Floors
1, --Ready to Move
'East', --Main Entrance
...
delete from CityList where LastUpdatedBy=@UserID
